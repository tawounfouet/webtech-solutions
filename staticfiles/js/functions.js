...
var e = {
    ...
    /* @required https://github.com/luisvinicius167/ityped */    typeText: function () {
      ...
      if (e.isVariableDefined(t)) {
          ...
          type.forEach(el => {
              ...
              // Détecter si on est en version mobile pour masquer le curseur
              var isMobile = window.innerWidth <= 767;
              
              ityped.init(el, {
                  strings: split_strings,
                  showCursor: !isMobile, // Masquer le curseur en mobile
                  typeSpeed: typespeed,
